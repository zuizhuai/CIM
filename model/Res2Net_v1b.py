...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = torch.load('D:\\Github\\pre_train\\res2net50_v1b_26w_4s-3cf99910.pth')
...
if __name__ == '__main__':
    ...
    # load image
    img = Image.open("D:\Github\Data\COD10K-v3\Train\Image\\COD10K-CAM-1-Aquatic-1-BatFish-1.jpg")
    # [N, C, H, W]
